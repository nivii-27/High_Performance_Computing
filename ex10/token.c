        ...
        if (tid < NUM_PRODUCERS) {
            ...
            if (file) {
                ...
                while (fgets(line, MAX_LINE, file)) {
                    // Added printf to show Producer activity
                    #pragma omp critical
                    printf(">>> Producer Thread %d: Reading line and adding to queue\n", tid);
            ...
            // CONSUMER LOGIC (Threads 1 and 2)
            char line[MAX_LINE];
            char *saveptr;
